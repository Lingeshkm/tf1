locals {
  ...
  bc_domain                   = "bc.intelerad.com"
  production_account_number   = "414952023392"
  staging_account_number      = "792686863424"
  dev_account_number          = "429656490274"
  rnd_ci_ip                   = "10.90.129.63"  // rnd-ci
  infrabuild_ip               = "10.90.152.53"  // infrabuild.intelerad.com
  rnd_artifacts_ip            = "10.90.129.56"  // rnd-artifacts.intelerad.com
}
...
module "ims-bc-base-infra" {
  ...
  vpc_subnets_app_2a    = "10.60.1.0/24"
  vpc_subnets_app_2b    = "10.60.2.0/24"
  vpc_subnets_lambda_2c = "10.60.3.0/24"
  vpc_subnets_lambda_2b = "10.60.4.0/24"
  vpc_subnets_rds_2a    = "10.60.5.0/26"
  vpc_subnets_rds_2b    = "10.60.5.64/26"
  vpc_subnets_elb_2a    = "10.60.5.128/26"
  vpc_subnets_elb_2b    = "10.60.5.192/26"
  vpc_subnets_build_2a  = "10.60.6.0/24"
  vpc_subnets_build_2b  = "10.60.7.0/24"
  vpc_subnets_endpoints_2a  = "10.60.8.0/26"
  vpc_subnets_endpoints_2b  = "10.60.8.64/26"
}
...
module "ims-bc-route53" {
  ...
  zone_id            = data.aws_route53_zone.route53_zone_id.id
  bitbucket_ip_addr  = "10.90.129.43"
  confluence_ip_addr = "10.90.129.43"
}
