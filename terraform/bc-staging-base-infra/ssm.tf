module "ssm" {
  ...
  rds_client_security_group      = module.ims-bc-base-infra.all_outbound_sg_id
  rnd_bcdb_fqdn                  = "not_used_stating"
  vpc_cidr_block                 = data.aws_vpc.vpc_ssm.cidr_block
  all_outbound_security_group    = module.ims-bc-base-infra.all_outbound_sg_id
  ev_latest_release_manifest_url = "https://testbuildrepo2.intelerad.com/modules/intelerad-enhancedviewer/release/intelerad-enhancedviewer.manifest.xml"
